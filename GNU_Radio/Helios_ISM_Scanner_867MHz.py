...
# Title: Helios_ISM_Scanner_867MHz
...
class Helios_ISM_Scanner_867MHz(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Helios_ISM_Scanner_867MHz", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Helios_ISM_Scanner_867MHz")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Helios_ISM_Scanner_867MHz")
...
def main(top_block_cls=Helios_ISM_Scanner_867MHz, options=None):
